...
const LandingPage = () => {
	return (
		<div className="min-h-screen bg-[#050a15] text-white font-sans">
			<nav className="flex justify-between items-center px-8 py-6 max-w-7xl mx-auto">
				<div className="flex items-center gap-2">
					...
					<span className="text-xl font-bold tracking-tight">
						NEXUS <span className="text-gray-500 font-light">TRACKER</span>
					</span>
				</div>
			...
			<section className="relative max-w-7xl mx-auto px-8 py-20 flex flex-col lg:flex-row items-center gap-12">
				<div className="flex-1 z-10 text-center lg:text-left">
					...
					<h1 className="text-5xl lg:text-6xl font-extrabold leading-tight mb-6 text-balance">
						Suporte Pós-Venda que{" "}
						<span className="text-blue-500">Escala seu Negócio</span>
					</h1>
					<p className="text-gray-400 text-lg mb-10 max-w-lg mx-auto lg:mx-0 leading-relaxed">
						Nossos especialistas dominam seus produtos para que você foque no
						que importa: crescer. Esqueça a fila de chamados, chame a Nexus
						Tracker.
					</p>
				</div>
			...
			<section
				id="sobre"
				className="py-24 bg-[#080e1a] border-y border-gray-800/50"
			>
				<div className="max-w-5xl mx-auto px-8 flex flex-col md:flex-row items-center gap-16">
					...
					<div className="md:w-2/3">
						...
						<div className="text-gray-400 space-y-4 text-lg leading-relaxed">
							<p>
								A <strong>Nexus Tracker</strong> é o braço direito de empresas
								que não abrem mão da excelência no pós-venda. Especializamo-nos
								em suporte técnico para produtos e equipamentos complexos,
								garantindo que sua marca mantenha a confiança do cliente muito
								após o fechamento do negócio.
							</p>
							<p>
								Nossos técnicos não apenas resolvem tickets; eles mergulham no
								funcionamento do seu produto para oferecer soluções definitivas.{" "}
								<span className="text-white font-medium">
									Deixe a complexidade técnica conosco
								</span>{" "}
								e elimine de vez a preocupação com o volume de chamados
								acumulados.
							</p>
						</div>
					</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
						{[
							...
							(
								...
								<div
									key={idx}
									className="flex flex-col items-center text-center group transition-transform hover:-translate-y-2"
								>
